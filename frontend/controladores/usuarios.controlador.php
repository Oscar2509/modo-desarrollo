			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$mail->setFrom('admin@email.com', 'Desarrollo Web');

					$mail->addReplyTo('admin@email.com', 'Desarrollo Web');
			...
			if(preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["passEmail"])){
				...
				if($respuesta1){
					...
					if($respuesta2  == "ok"){
						...
						$mail->setFrom('admin@email.com', 'Equipo Desarrollo Web');

						$mail->addReplyTo('admin@email.com', 'Equipo Desarrollo Web');
